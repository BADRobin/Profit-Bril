...
<fieldset>
    ...
    <select onchange="window.location.href=this.options[this.selectedIndex].value" name="option" class="option">
        ...
        <option value="${pageContext.request.contextPath}/">На галавную</option>
...
<div>
    <table border="1">
        <tr><th width="10%">№</th><th width="30%">Автор</th><th width="30%">Книга</th><th width="30%">Жанр литературы</th></tr>
